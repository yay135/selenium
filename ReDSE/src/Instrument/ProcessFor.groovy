...
class ProcessFor {
	...
	public ProcessFor(def forStmt, def file, def programHash, ArrayList<ArrayList<String>> listForInput, ArrayList<String> listEnv, HashMap<String, String> mapForDefined) 
	{
		...
		loopstmts.each {stmt ->
			...
			finalForBlock = finalForBlock + statementHead + mainStatement + statementTail;
		}
